...
def portOpen(COMPort):
    ...
    if (ValueError==0):
        ...
        logging.error( 'Could not open port. Tried: {}, ErrorCode: {}'.format( COMPort.value, ValueError ) )
    return ValueError 

def portClose(COMPort):
    #int32_t __cdecl PortClose(char COMport[]);
    ValueError = 0
    ValueError += dll.PortClose(COMPort)
    if (ValueError==0):
        logging.info( 'Port Closed: {}'.format(COMPort.value) )
    else:
        logging.error( 'Could not close port. Tried: {}, ErrorCode: {}'.format( COMPort.value, ValueError ) )
    return ValueError
...
def getSuperKInfo(COMPort):
    ...
    if (ValueError==0):
        ...
        logging.info( 'Could not get SuperK Info. ErrorCode: {}'.format( ValueError ) )
    return ValueError
...
def getVariaInfo(COMPort):
    ...
    if (ValueError==0):
        ...
        logging.info( 'Could not get Varia Info. ErrorCode: {}'.format( ValueError ) )
    return ValueError
...
def getVariaReadings(COMPort):
    ...
    if (ValueError==0):
        ...
        logging.error( 'Could not successfully get Varia readings. ErrorCode: {}'.format( ValueError ) )
    return ValueError
...
def getSuperKReadings(COMPort):
    ...
    if (ValueError==0):
        ...
        logging.error( 'Could not successfully get SuperK Readings. ErrorCode: {}'.format( ValueError ) )
    return ValueError
...
def getVariaStatusBits(COMPort,bitCluster):
    ...
    if (ValueError==0):
        ...
        logging.error( 'Could not get Varia Status Bits. ErrorCode: {}'.format( ValueError ) )
    return ValueError 
...
def getSuperKStatusBits(COMPort,bitCluster):
    ...
    if (ValueError==0):
        ...
        logging.error( 'Could not get SuperK Status Bits. ErrorCode: {}'.format( ValueError ) )
    return ValueError 
...
def getVariaControls(COMPort):
    ...
    if (ValueError==0):
        ...
        logging.error( 'Could not open port. Tried: {}, ErrorCode: {}'.format( COMPort.value, str(ValueError) ) )
    return ValueError 
...
def setSuperKControls(COMPort,controlCluster,bitCluster):
    ...
    if (ValueError==0):
        ...
        logging.error( 'Could not set SuperK Status Bits. ErrorCode: {}'.format( ValueError ) )
    return ValueError 
...
def setSuperKControlEmission(COMPort,state,superKbitCluster,variabitCluster):
    ...
    if (ValueError!=0):
        logging.error( 'Could not set SuperK Emission. ErrorCode: {}'.format( COMPort.value, str(ValueError) ) )
    return ValueError 
...
def setSuperKControlInterlock(COMPort,state,bitCluster):
    ...
    if (ValueError!=0):
        logging.error( 'Could not set SuperK Interlock. ErrorCode: {}'.format( str(ValueError) ) )
    return ValueError 
...
def setVariaControls(COMPort, NDFilterSetpointPercentx10, SWFilterSetpointAngstrom, LPFilterSetpointAngstrom, superKBitCluster, variaBitCluster):
    ...
    if (ValueError!=0):
        logging.error( 'Could not set Varia Controls. ErrorCode: {}'.format( ValueError ) )
    return ValueError 
...
def initialise(COMPort, superKControlCluster, superKBitCluster, variaBitCluster):
    ...
    if (ValueError==0):
        ...
        logging.error( 'Error during Initialisation. ErrorCode: {}'.format( ValueError ) )
    return ValueError 
...
def setSafeStates(COMPort, superKControlCluster, superKBitCluster, variaBitCluster):
    ...
    if (ValueError==0):
        ...
        logging.error( 'Error Setting Safe States. ErrorCode: {}'.format( ValueError ) )
    return ValueError 
