...
class U12(object):
    ...
    def open(self, id = -1, serialNumber = None):
        ...
        """
        if ON_WINDOWS:
            print "Opening Device on Windows (CJ)"
            pass
        #alpha = 10
        #if alpha != 10:
        #    pass 
    ...
    def eDigitalIn(self, channel, idNum = None, demo = 0, readD=1):
        """
        Name: U12.eDigitalIn(channel, idNum = None, demo = 0, readD=1)
    ...
    def eDigitalOut(self, channel, state, idNum = None, demo = 0, writeD=1):
        """
        Name: U12.eDigitalOut(channel, state, idNum = None, demo = 0, writeD=1)
        ...
        if ON_WINDOWS:
            ...
            return {"idnum":ljid.value,"state":state}
        else:
            oldstate = self.rawDIO()
